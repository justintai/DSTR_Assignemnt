...
//
//		cout << tutorshead->TutorID << " - " << tutorshead->Name << " - " << date_join << "/" << month_join << "/" << year_join << " - " << date_terminate << "/" << month_terminate << "/" << year_terminate
...
//
//		cout << tutorstail->TutorID << " - " << tutorstail->Name << " - " << date_join << "/" << month_join << "/" << year_join << " - " << date_terminate << "/" << month_terminate << "/" << year_terminate
